...
class MNIST360(GCLDataset):
        ...
        for j in range(self.N_CLASSES):
            ...
            for k in range(self.num_rounds * 2):
                ...
                self.train_loaders[-1].append(create_seeded_dataloader(self.args,
                                                                       tmp_train_dataset, target_classes=[], batch_size=1, shuffle=True, num_workers=0))
    ...
    def init_test_loaders(self) -> None:
        ...
        for j in range(self.N_CLASSES):
            ...
            self.test_loaders.append(create_seeded_dataloader(self.args, tmp_test_dataset, target_classes=[],
